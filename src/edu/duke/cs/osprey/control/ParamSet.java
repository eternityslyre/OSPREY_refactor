...
public class ParamSet implements Serializable {
	...
	//TODO: This is not a good function. First of all, it should be named more appropriately, such as
	// findAllParamsContaining or something. Secondly, this indicates (and I want to change this) that
	// we have a lot of parameter redundancy so we can't distinguish between parameters that are all part of a group
	// and parameters that are conceptually distinct. 
	// We don't need more config files for this but we could certainly do smarter parsing.
