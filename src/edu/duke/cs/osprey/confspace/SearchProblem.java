...
public class SearchProblem implements Serializable {
    ...
    public SearchProblem(String name, String PDBFile, ArrayList<String> flexibleRes, ArrayList<ArrayList<String>> allowedAAs, boolean addWT,
            ...
            boolean addResEntropy, boolean addWTRots, boolean usePDBAlternatesAsRotamers){
        
        confSpace = new ConfSpace(PDBFile, flexibleRes, allowedAAs, addWT, contSCFlex, dset, 
        		moveableStrands, freeBBZones, useEllipses, addWTRots, usePDBAlternatesAsRotamers);
        this.name = name;
